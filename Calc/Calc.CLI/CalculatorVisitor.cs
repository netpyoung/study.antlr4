...
using OperandContext = Calc.Gen.CalculatorParser.OperandContext;
using ExpressionContext = Calc.Gen.CalculatorParser.ExpressionContext;

namespace Calc.CLI
{
    internal class CalculatorVisitor : Calc.Gen.CalculatorBaseVisitor<int>
    {
